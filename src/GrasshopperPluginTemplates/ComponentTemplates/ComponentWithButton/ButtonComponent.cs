...
namespace Poaceae
{
    ...
    public abstract class ButtonComponent : GH_Component
    {
        ...
        /// <summary>
        /// The default PostConstructor will be delayed so the buttonName can be passed to the base constructor which creates the interface based on the component attributes.
        ...
        {
            Attributes = new ButtonComponentAttributes(this, _buttonName);
