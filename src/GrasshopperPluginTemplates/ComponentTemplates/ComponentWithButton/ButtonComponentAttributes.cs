...
namespace Poaceae
{
    ...
    /// A button event is triggered when the left mouse button is released after the left mouse button was clicked inside the button area.
    /// </summary>
    internal class ButtonComponentAttributes : GH_ComponentAttributes
    {
        ...
        /// The background color of the button will be set to a special color to indicate that the button was clicked inside the render function.
        /// </summary>
